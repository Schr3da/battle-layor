...
const drawWalls = (e: Entity, map: any[], assets: AssetManager) => {
    ...
    for (let rayIdx = 0; rayIdx < displayWidth; rayIdx++) {
        ...
        while (hit == 0) {
          ...
          hit = map[Math.round(mapX)][Math.round(mapY)] > 0 ? 1 : hit;  
        }
...
export const updateView = (e: Entity, m: any[], assets: AssetManager) => {
    drawWalls(e, m, assets);
